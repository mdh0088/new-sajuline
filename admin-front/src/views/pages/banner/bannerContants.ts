export const bannerHeader:Array<Tableheader> = [
    {value:'banner_idx', label:'인덱스', isShow:false, type:"key", width:'', options:{}, isSortable:false},
    ...
    {value:'bannerNm',label:'배너 이름', isShow:true, type:"key", width:'', options:{}, isSortable:false},
    {value:'fileNm',label:'업로드 파일명', isShow:true, type:"text", width:'', options:{}, isSortable:false},
    {value:'target',label:'노출 타입', isShow:true, type:"custom", width:'', options:{}, isSortable:false},
