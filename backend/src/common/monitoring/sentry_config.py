    ...
    try:
        sentry_sdk.init(
            ...
            integrations=[
                ...
                RedisIntegration(),       # Redis 캐시 명령 추적
            ],
        ...
        with sentry_sdk.configure_scope() as scope:
            ...
            scope.set_tag("docker", str(settings.docker_env))
        
        # 초기화 성공 로그
        print(f"✅ Sentry 초기화 완료 - 환경: {settings.environment}, 릴리스: {settings.service_name}@{settings.service_version}")
