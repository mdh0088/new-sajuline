...
class naverRestAPI{
    ...
    var $client_id      = "UbulJR6fs_MM2G5QGMFC";
    var $client_secret  = "nnfCqQCL13";
    var $redirect_uri   = "https://sajutarot.com/api/social/naver_login.php";
    var $result_uri     = '/app/user/join_sns_callback?join_type=naver';
