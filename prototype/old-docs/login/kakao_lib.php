...
class kakaoRestAPI{
    ...
    //var $restapi_key = 'd350fd6d69f21fb2a55646f17cf969f4'; # 운영 key
    var $restapi_key = '52c3b7fd29640d0794c65676ccea1e8a'; # 테스트 key

    // <수정필요> 리다렉트 URL : kakao developers > 내 애플리케이션 > 제품설정 > 카카오 로그인 > Redirect URI
    var $redirect_uri = './kakao_login.php';

    // <수정필요> 카카오 로그인 인증 후 이동할 페이지
    var $result_uri = './join_sns_callback.php?join_type=kakao';
