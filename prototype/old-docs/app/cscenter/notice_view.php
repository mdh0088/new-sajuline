...
<section id="csCenterWrap" class="section">
	...
	<div class="noticeView">
		...
		<div class="tbox">
            <img src="/app/assets/img/contents/img-main-banner01.png" width="360">
		</div>
		<div class="btnArea">
			...
			<button type="button" class="nextBtn end" onclick="javascript:location.href='/app/cscenter/notice_view2'">다음</button> <!-- 마지막글에 class="end" 추가 -->
		</div>
	</div>
