...
<section id="csCenterWrap" class="section">
	...
	<div class="noticeView">
		...
		<div class="tbox">
            <img src="/app/assets/img/contents/img-main-banner03.png" width="360">
		</div>
		<div class="btnArea">
			<button type="button" class="prevBtn"onclick="javascript:location.href='/app/cscenter/notice_view2'">이전</button>
