...
$chk_query = "SELECT  count(*) as cnt FROM TBL_CS_REVIEW_DUMY WHERE  DATE_FORMAT(REGIST_DATE,'%Y-%m-%d') = '".$_GET['format']."'";
...
if($row['cnt'] < 1){
    ...
    <script>
        alert('리뷰가 존재하지 않습니다.');
        location.href='/app/admin/review/dumy_daily_list';
    </script>
    ";
}
...
$query =
    "
        ...
        FROM TBL_CS_REVIEW_DUMY AA, TBL_CS BB WHERE
            AA.CS_IDX = BB.IDX
            AND DATE_FORMAT(AA.REGIST_DATE,'%Y-%m-%d') = '".$_GET['format']."'
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>더미 유저 : <?php echo $row['USER_ID'] ?></p>
                                            <p>더미 유저 리뷰 :</p>
