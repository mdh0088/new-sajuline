...
<!-- tabWrap -->
		<div class="tabWrap">
			<div class="tabList">
				<ul>
					<li class="on">
						<button type="button" onclick="tabOpen(event, this, 'fortune01');">상담가능</button>
					</li>
					<li>
						<button type="button" onclick="tabOpen(event, this, 'fortune02')">상담중</button>
					</li>
					<li>
						<button type="button" onclick="tabOpen(event, this, 'fortune03')">신규</button>
					</li>
				</ul>
			</div>
			<div id="cs_area" class="tabContWrap">
				...
				<!-- fortune01 -->
				<div id="fortune01" class="tabContItem">
					<div class="csBox">
						<div class="flBox">
							<div class="ibox">
				...
				<!-- fortune02 -->
				<div id="fortune02" class="tabContItem">
					<div class="csBox">
						<div class="flBox">
							<div class="ibox">
								<span class="cate">타로</span>
				...
				<!--// fortune02 -->
				<!-- fortune03 -->
				<div id="fortune03" class="tabContItem">
					<div class="csBox">
						<div class="flBox">
							<div class="ibox">
								<span class="cate">타로</span>
